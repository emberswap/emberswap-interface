...
import { EMBER_DISTRIBUTOR_ADDRESS, EMBER_VAULT_ADDRESS } from '../../constants/addresses'
...
const VaultListItem = ({ farm }) => {
  ...
  const [approvalState, approve] = useApproveCallback(typedDepositValue, EMBER_VAULT_ADDRESS[chainId])
      ...
      <Modal isOpen={showConfirmation} onDismiss={() => setShowConfirmation(false)}>
        <div className="space-y-4">
          ...
          <Typography variant="lg" className="font-medium pt-4">
            {i18n._(
              t`${
                currentAction.action == 'deposit' ? 'Staking on Ember Vault' : 'Harvesting'
          ...
          <div className="grid grid-cols-2 gap-4 p-4">
            <div className="col-span-2 text-center md:col-span-1">
              ...
              <div className="relative flex items-center w-full mb-4">
                <NumericalInput
                  className="w-full px-4 py-4 pr-20 rounded bg-dark-7000 focus:ring focus:ring-dark-purple"
                  value={depositValue}
