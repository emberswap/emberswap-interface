...
export default function LiquidityHeader({ input = undefined, output = undefined }: any): JSX.Element {
  ...
  return (
    <div className="grid grid-cols-2 rounded-md p-3px bg-dark-800">
      <NavLink
        activeClassName="font-bold text-high-emphesis backdrop-blur-md	bg-dark-900-custom"
      ...
      <NavLink
        ...
        activeClassName="text-high-emphesis font-bold backdrop-blur-md bg-dark-900-custom"
