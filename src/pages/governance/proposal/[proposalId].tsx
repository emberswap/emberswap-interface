...
import { castVote, formatEmber, VOTING_API_URL } from '../../../features/governance/util'
            ...
            <>
              <div className="flex flex-col w-full p-4 border-t-0 rounded bg-dark-800">
                ...
                <div className="gap-4">
                  ...
                  <span className="float-left mt-2">Your voting power: {formatEmber(proposal.userVotingPower)} EMBER</span>
              ...
              <div className="flex flex-col w-full p-4 border-t-0 rounded bg-dark-800">
                ...
                {proposal?.votes.map(vote => (
                  <div key={vote.address} className="grid grid-cols-10">
                    ...
                    <span className="flex items-baseline flex-nowrap">{formatEmber(vote.amount)} <span className="hidden pl-1 text-xs md:flex">EMBER</span></span>
                    </div>
                  </div>
                ))}
              </div>
