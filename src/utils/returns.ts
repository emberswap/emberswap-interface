...
export const priceOverrides = [
  '0xe1e655be6f50344e6dd708c27bd8d66492d6ecaf', // USDC
  '0x7b2b3c5308ab5b2a1d9a94d20d35ccdf61e05b72', // DAI
]
...
const PRICE_DISCOVERY_START_TIMESTAMP = 1645279200
...
function formatPricesForEarlyTimestamps(position): Position {
  if (position.timestamp < PRICE_DISCOVERY_START_TIMESTAMP) {
    ...
    // WETH price
    if (position.pair?.token0.id === '0x3743ec0673453e5009310c727ba4eaf7b3a1cc04') {
      position.token0PriceUSD = 310
    }
    if (position.pair?.token1.id === '0x3743ec0673453e5009310c727ba4eaf7b3a1cc04') {
      position.token1PriceUSD = 310
    }
  }
  return position
}
