...
export const RPC = {
  ...
  [ChainId.SMARTBCH]: 'https://global.uat.cash', // 'https://smartbch.greyh.at', 'https://smartbch.fountainhead.cash/mainnet'
...
export const LNS_METADATA_URL: { [chainId in ChainId]?: string } = {
  ...
  [ChainId.SMARTBCH_TESTNET]: 'https://metadata.bch.domains/smartbch-amber',
}
