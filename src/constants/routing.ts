...
import { Currency, Token, WNATIVE, ChainId, NATIVE, BCH, NativeCurrency } from '../sdk'
...
const WRAPPED_NATIVE_ONLY: ChainTokenList = {
  ...
  [ChainId.SMARTBCH_TESTNET]: [WNATIVE[ChainId.SMARTBCH_TESTNET]],
}
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.SMARTBCH]: [...WRAPPED_NATIVE_ONLY[ChainId.SMARTBCH], SMARTBCH.EMBER, SMARTBCH.FLEXUSD, SMARTBCH.LAWUSD],
  [ChainId.SMARTBCH_TESTNET]: [...WRAPPED_NATIVE_ONLY[ChainId.SMARTBCH_TESTNET], SMARTBCH_TESTNET.EMBER, SMARTBCH_TESTNET.FLEXUSD],
}
...
export const COMMON_BASES: ChainTokenList = {
  ...
  [ChainId.HECO]: [...WRAPPED_NATIVE_ONLY[ChainId.HECO], HECO.DAI, HECO.USDC, HECO.USDT, HECO.WBTC, HECO.WETH],
  [ChainId.OKEX]: [...WRAPPED_NATIVE_ONLY[ChainId.OKEX], OKEX.DAI, OKEX.USDC, OKEX.USDT, OKEX.WBTC, OKEX.WETH],
  [ChainId.SMARTBCH]: [...WRAPPED_NATIVE_ONLY[ChainId.SMARTBCH], SMARTBCH.EMBER, SMARTBCH.FIRE, SMARTBCH.FLEXUSD],
  [ChainId.SMARTBCH_TESTNET]: [...WRAPPED_NATIVE_ONLY[ChainId.SMARTBCH_TESTNET], SMARTBCH_TESTNET.EMBER, SMARTBCH_TESTNET.FIRE, SMARTBCH_TESTNET.FLEXUSD],
  // [ChainId.CELO]: [
  //   ...WRAPPED_NATIVE_ONLY[ChainId.CELO],
  //   CELO.mCUSD,
  //   CELO.mCELO,
...
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
  ...WRAPPED_NATIVE_ONLY,
  [ChainId.MAINNET]: [...WRAPPED_NATIVE_ONLY[ChainId.MAINNET], DAI, USDC, USDT, WBTC],
  [ChainId.SMARTBCH]: [...WRAPPED_NATIVE_ONLY[ChainId.SMARTBCH], SMARTBCH.EMBER, SMARTBCH.FIRE, SMARTBCH.FLEXUSD, SMARTBCH.LAWUSD],
  [ChainId.SMARTBCH_TESTNET]: [...WRAPPED_NATIVE_ONLY[ChainId.SMARTBCH_TESTNET], SMARTBCH_TESTNET.EMBER, SMARTBCH_TESTNET.FLEXUSD],
  [ChainId.MATIC]: [...WRAPPED_NATIVE_ONLY[ChainId.MATIC], MATIC.USDC, MATIC.WBTC, MATIC.DAI, MATIC.WETH, MATIC.USDT],
  [ChainId.FANTOM]: [...WRAPPED_NATIVE_ONLY[ChainId.FANTOM], FANTOM.DAI, FANTOM.USDC, FANTOM.WBTC, FANTOM.WETH],
  [ChainId.BSC]: [...WRAPPED_NATIVE_ONLY[ChainId.BSC], BSC.DAI, BSC.USD, BSC.USDC, BSC.USDT, BSC.BTCB, BSC.WETH],
...
export const INIT_CODE_HASH: string = '0x4eae98fedf0a51d24c5a3a59dddb69e9fbeead94344889e370a14507c35f9b4a'
