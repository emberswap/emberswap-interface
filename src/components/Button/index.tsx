...
const FLEXED = {
  ...
  gray: 'border rounded shadow-sm focus:ring-2 focus:ring-offset-2 bg-darker bg-opacity-80 flex text-primary border-dark-800 hover:bg-opacity-100 focus:ring-offset-dark-700-custom focus:ring-dark-800 disabled:bg-opacity-80',
  graytoo: 'border rounded shadow-sm focus:ring-2 focus:ring-offset-2 bg-darker bg-opacity-80 flex text-primary border-dark-800 hover:bg-opacity-100 focus:ring-offset-dark-700-custom focus:ring-dark-800 disabled:bg-opacity-80',
...
const FILLED = {
  ...
  gray: 'border rounded shadow-sm focus:ring-2 focus:ring-offset-2 bg-darker bg-opacity-80 w-full text-primary border-dark-800 hover:bg-opacity-100 focus:ring-offset-dark-700-custom focus:ring-dark-800 disabled:bg-opacity-80',
  graytoo: 'border rounded shadow-sm focus:ring-2 focus:ring-offset-2 bg-darker bg-opacity-80 w-full text-primary border-dark-800 hover:bg-opacity-100 focus:ring-offset-dark-700-custom focus:ring-dark-800 disabled:bg-opacity-80',
...
const OUTLINED = {
  ...
  gray: 'bg-dark-700-custom bg-opacity-20 outline-gray rounded text-gray hover:bg-opacity-40 disabled:bg-opacity-20',
  graytoo: 'bg-darker bg-opacity-20 outline-gray rounded text-gray hover:bg-opacity-40 disabled:bg-opacity-20',
  ...
  gradient:
    'border border-transparent border-gradient-r-purple-dark-900 opacity-80 hover:opacity-100 disabled:bg-opacity-100 disabled:border-dark-800 disabled:bg-none disabled:bg-dark-700-custom',
}
