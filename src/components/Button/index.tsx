...
const FLEXED = {
  ...
  gray: 'border rounded shadow-sm focus:ring-2 focus:ring-offset-2 bg-darker bg-opacity-80 flex text-primary border-dark-800 hover:bg-opacity-100 focus:ring-offset-dark-700 focus:ring-dark-800 disabled:bg-opacity-80',
  graytoo: 'border rounded shadow-sm focus:ring-2 focus:ring-offset-2 bg-darker bg-opacity-80 flex text-primary border-dark-800 hover:bg-opacity-100 focus:ring-offset-dark-700 focus:ring-dark-800 disabled:bg-opacity-80',
...
const FILLED = {
  ...
  gray: 'border rounded shadow-sm focus:ring-2 focus:ring-offset-2 bg-darker bg-opacity-80 w-full text-primary border-dark-800 hover:bg-opacity-100 focus:ring-offset-dark-700 focus:ring-dark-800 disabled:bg-opacity-80',
  graytoo: 'border rounded shadow-sm focus:ring-2 focus:ring-offset-2 bg-darker bg-opacity-80 w-full text-primary border-dark-800 hover:bg-opacity-100 focus:ring-offset-dark-700 focus:ring-dark-800 disabled:bg-opacity-80',
